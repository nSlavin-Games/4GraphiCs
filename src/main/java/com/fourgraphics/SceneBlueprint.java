...
public class SceneBlueprint {
	...
	protected void initialize() {
		if (!isInitialized) { //se la scena non � ancora stata inizializzata
		...
		isInitialized = true; //scena gi� inizializzata precedentemente
