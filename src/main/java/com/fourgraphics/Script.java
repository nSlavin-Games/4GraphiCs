...
public class Script {
    ...
    public void FixedUpdate() {} //metodo di update eseguito ogni tot tempo preciso
    public void OnCollisionEnter(Collider self, Collider other, CollisionDirection direction) {} //eseguito quando l’oggetto entra in collisione con qualcosa
}